    ...
    render() {
        return (
            <div>
                ...
                {this.state.active > 0 && this.state.active < 2 ? <a onClick={this.handleClickDecrement} className="button button-black mb-20 text-center btn-back col-md-3"><i className="fa fa-arrow-left" /><span>{this.state.handlerBack} </span></a> : null}
                {this.state.active >= 0 && this.state.active < 2 ? <a onClick={this.handleClickIncrement} className="button button-black mb-20 text-center btn-frwd col-md-3"><span>{this.state.handlerNext} </span><i className="fa fa-handshake-o" /></a> : null}
                </div>
            </div>
        )
    }
            ...
            <div className="clearfix">
              ...
              <div className="contact-form clearfix">
                ...
                <div className="section-field full-width">
                  ...
                  <input type="text" placeholder="Email*" name="name" className="placeholder" />
                </div>
              </div>
            </div>
          </div>            
        ...
        return ( 
          <div className="alerts-and-callouts">
           <div className="bs-callout bs-callout-success">
             <h4>You Have Successfully Registered</h4> Please check your email for further process.
           </div>
           </div>
        )             
    }
